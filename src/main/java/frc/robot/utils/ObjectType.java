...
public enum ObjectType {
    APRIL_TAG("April Tag", "This object type is for AprilTags", "limelight", 480, 640, 0.0, 59.6, 45.7),
    ...
    NOTE("Note", "This object type is for Notes", "limelight", 480, 640, 0.0, 59.6, 45.7);
